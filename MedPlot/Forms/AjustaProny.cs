...
namespace MedPlot
{
    public partial class AjustaProny : Form
    {
        GraficoProny f;
        Chart graf;
        DateTime di;
        ...
        public AjustaProny(GraficoProny form, Chart grafico, DateTime dataIni, double taxa, string chartAxis)
        {
            InitializeComponent();
        ...
        private void AppliesProperties()
        {
            try
            {
                ...
                if (!checkBox2.Checked)
                {
                    ...
                    if ((minimumDate.TimeOfDay.TotalSeconds - di.TimeOfDay.TotalSeconds > -1) &&
                    ...
                    {
                        //graf.ChartAreas[0].AxisX.Minimum = (minimumDate.TimeOfDay.TotalSeconds - di.TimeOfDay.TotalSeconds) * tx + 1.0;
                        //graf.ChartAreas[0].AxisX.Maximum = (maximumDate.TimeOfDay.TotalSeconds - di.TimeOfDay.TotalSeconds) * tx + 1.0;
                        // Limites da visualização
                    ...
                    else if ((minimumDate.TimeOfDay.TotalSeconds - di.TimeOfDay.TotalSeconds < -1) ||
                        ((maximumDate.TimeOfDay.TotalSeconds - di.TimeOfDay.TotalSeconds) * tx > graf.ChartAreas[0].AxisX.Maximum))
                    {
